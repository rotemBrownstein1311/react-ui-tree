...
var UITreeNode = /*#__PURE__*/function (_Component) {
  ...
  function UITreeNode(props) {
    ...
    _this.renderChildren = function () {
      ...
      if (index.children && index.children.length) {
        ...
        return /*#__PURE__*/React__default.createElement("div", {
          ...
          return /*#__PURE__*/React__default.createElement(UITreeNode, {
            tree: tree,
            index: childIndex,
            key: childIndex.id,
            dragging: dragging,
    ...
    _this.innerRef = /*#__PURE__*/React__default.createRef();
    return _this;
  }
...
var UITree = /*#__PURE__*/function (_Component) {
  ...
  function UITree(_props) {
    ...
    _this.getDraggingDom = function () {
      if (_this.props.renderDraggedDom) {
        ...
        if (dragging && dragging.id) {
          ...
          }, /*#__PURE__*/React__default.createElement(UITreeNode, {
            tree: tree$$1,
            index: draggingIndex,
            paddingLeft: _this.props.paddingLeft
          }));
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: "m-tree"
    }, draggingDom, /*#__PURE__*/React__default.createElement(UITreeNode, {
      tree: tree$$1,
