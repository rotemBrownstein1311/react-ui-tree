...
export default class UITree extends Component {
  ...
  getDraggingDom = () => {
    if (this.props.renderDraggedDom) {
  ...
  dragStart = (id, dom, e) => {
    const shouldStartDragNode = this.props.shouldStartDrag && this.props.shouldStartDrag(this.state.tree.getIndex(id).node);
    ...
    const treeBackup = new Tree(JSON.parse(JSON.stringify(this.state.tree.obj)));
    treeBackup.isNodeCollapsed = this.state.tree.isNodeCollapsed;
    treeBackup.renderNode = this.state.tree.renderNode;
    treeBackup.changeNodeCollapsed = this.state.tree.changeNodeCollapsed;
  ...
  dragEnd = () => {
    ...
    if (this.props.shouldDropNode) {
      if (this.props.shouldDropNode(this.state.tree.obj)) {
        this.change(this.state.tree);
      } else {
        this.setState({tree: this.state.treeBackup, treeBackup: {}})
      }
    }
